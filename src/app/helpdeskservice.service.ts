...
isLoggedIn:any;
  ...
  constructor(private Http: HttpClient,private token: TokenStorageService) { 
   ...
   httpOptions =
    { headers: new HttpHeaders().set('Authorization',`Bearer ${"eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzYWlkIiwiaWF0IjoxNjg1ODMzOTEzLCJleHAiOjE2ODU5MjAzMTN9.roerEJxqEGElOduAwoo8IENPgwRLq06TL52EcDFdEwjEQRkbscmyxmZjS7dbXokX1OnpjGsIX9ODIPBRYkWzbA"}`)};
