...
export class RequestComponent implements OnInit   {
  ...
  username?: string;
    ...
    quillEditorModules = {};
  constructor(private elementRef: ElementRef,private tokenStorageService: TokenStorageService,private builder: FormBuilder,private service: HelpdeskserviceService) {
